...
import { crearMaquina } from "../../helpers/queries";
...
const CrearMaquinas = () => {
  ...
  const onSubmit = (maquinaNueva) => {
    ...
    crearMaquina(maquinaNueva).then((respuesta)=>{
      if(respuesta && respuesta.status === 201){
        Swal.fire('Producto creado', `El producto ${maquinaNueva.nombreMaquina} fue creado correctamente`, 'success');
        reset();
      }else{
  ...
  return (
    ...
    <h1 className="display-4 mt-5">Gestion y administracion de maquinaria</h1>
    <hr />
